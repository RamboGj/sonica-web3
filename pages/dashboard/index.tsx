...
import { DeployedContractsTable } from '../../components/ContractsTable/DeployedContractsTable'
...
export default function Dashboard() {
  ...
  if (combinedList) {
    return (
      <>
        <div className="pt-5 max-w-[1060px] mx-auto flex justify-end items-center">
          <div>
            <Button
